# 네이버 데이터랩 쇼핑인사이트 API 명세서

> **출처**: [네이버 개발자 센터 - 쇼핑인사이트](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-개요)

---

# 쇼핑인사이트

- [쇼핑인사이트 개요](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-개요)
- [쇼핑인사이트 API 레퍼런스](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-api-레퍼런스)
- [쇼핑인사이트 API 구현 예제](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#쇼핑인사이트-api-구현-예제)

## 쇼핑인사이트 개요

- [개요](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EA%B0%9C%EC%9A%94)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)
...
4. **애플리케이션 등록 (API이용신청)** 페이지에서 [애플리케이션 등록 세부 정보](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98-%EB%93%B1%EB%A1%9D-%EC%84%B8%EB%B6%80-%EC%A0%95%EB%B3%B4)를 입력한 다음 **등록하기**를 클릭합니다.
...
![](https://developers.naver.com/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/datalab/shopping/images/datalab-shopping-01.png)
...
![](https://developers.naver.com/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/datalab/shopping/images/datalab-shopping-02.png)

## 쇼핑인사이트 API 레퍼런스

- [쇼핑인사이트 분야별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 분야 내 기기별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC-%EB%82%B4-%EA%B8%B0%EA%B8%B0%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 분야 내 성별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC-%EB%82%B4-%EC%84%B1%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 분야 내 연령별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%B6%84%EC%95%BC-%EB%82%B4-%EC%97%B0%EB%A0%B9%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 키워드별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 키워드 기기별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C-%EA%B8%B0%EA%B8%B0%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 키워드 성별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C-%EC%84%B1%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [쇼핑인사이트 키워드 연령별 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%87%BC%ED%95%91%EC%9D%B8%EC%82%AC%EC%9D%B4%ED%8A%B8-%ED%82%A4%EC%9B%8C%EB%93%9C-%EC%97%B0%EB%A0%B9%EB%B3%84-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [오류 코드](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#%EC%98%A4%EB%A5%98-%EC%BD%94%EB%93%9C)
...
| ages | array(JSON) | N | 연령. 검색 사용자의 연령에 따른 조건입니다.<br>- 설정 안 함: 모든 연령<br>- `10`: 10∼19세<br>- `20`: 20∼29세<br>- `30`: 30∼39세<br>- `40`: 40∼49세<br>- `50`: 50∼59세<br>- `60`: 60세 이상 |
...
| results.category | string | 쇼핑 분야 코드 |
| results.data.period | string | 구간별 시작 날짜(`yyyy-mm-dd` 형식) |
| results.data.group | string | 연령. 검색 사용자의 연령에 따른 조건입니다.<br>- `10`: 10∼19세<br>- `20`: 20∼29세<br>- `30`: 30∼39세<br>- `40`: 40∼49세<br>- `50`: 50∼59세<br>- `60`: 60세 이상 |
| results.data.ratio | number | 구간별 클릭량의 상대적 비율. 구간별 결과에서 가장 큰 값을 100으로 설정한 상댓값입니다. |
...
- [Java](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#java)
- [PHP](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#php)
- [Node.js](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#node-js)
- [Python](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#python)
- [C#](https://developers.naver.com/docs/serviceapi/datalab/shopping/shopping.md#c)
