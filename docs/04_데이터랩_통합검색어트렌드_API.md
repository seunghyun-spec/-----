...
> **출처**: [네이버 개발자 센터 - 통합 검색어 트렌드](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#통합-검색어-트렌드)

---

# 통합 검색어 트렌드

- [통합 검색어 트렌드 개요](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#통합-검색어-트렌드-개요)
- [통합 검색어 트렌드 API 레퍼런스](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#통합-검색어-트렌드-api-레퍼런스)
- [통합 검색어 트렌드 API 구현 예제](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#통합-검색어-트렌드-api-구현-예제)

## 통합 검색어 트렌드 개요

- [개요](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#%EA%B0%9C%EC%9A%94)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)
...
4. **애플리케이션 등록 (API이용신청)** 페이지에서 [애플리케이션 등록 세부 정보](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98-%EB%93%B1%EB%A1%9D-%EC%84%B8%EB%B6%80-%EC%A0%95%EB%B3%B4)를 입력한 다음 **등록하기**를 클릭합니다.
...
![](https://developers.naver.com/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/datalab/search/images/datalab-01.png)
...
![](https://developers.naver.com/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/datalab/search/images/datalab-02.png)

## 통합 검색어 트렌드 API 레퍼런스

- [네이버 통합 검색어 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#%EB%84%A4%EC%9D%B4%EB%B2%84-%ED%86%B5%ED%95%A9-%EA%B2%80%EC%83%89%EC%96%B4-%ED%8A%B8%EB%A0%8C%EB%93%9C-%EC%A1%B0%ED%9A%8C)
- [오류 코드](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#%EC%98%A4%EB%A5%98-%EC%BD%94%EB%93%9C)
...
- [Java](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#java)
- [PHP](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#php)
- [Node.js](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#node-js)
- [Python](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#python)
- [C#](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#c)
